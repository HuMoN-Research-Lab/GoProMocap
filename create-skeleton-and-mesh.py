...
arr = np.load(r"/Users/chris/JugglingProject/CJC/JugglingPractice0005_20200331/Processed/output_3d_skeleton_with_hands.npy") 
...
for frame in range(scene.frame_start, 10):
    ...
    scene.render.filepath = "/Users/chris/JugglingProject/CJC/JugglingPractice0005_20200331/Processed/" + str(frame).zfill(4)
