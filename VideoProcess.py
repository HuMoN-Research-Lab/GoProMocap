...
def runOPandDLC():
  ...
  #      for video in os.listdir(dir):
            #STILL NEED TO MAKE AN IF STATEMENT TO JOIN TWO VIDEOS
   ...
   # for dir in datadir2:
    ...
    for dir in datadir3:
        for video in os.listdir(dir):
            videoName = video[:4]
            subprocess.call(['bin/OpenPoseDemo.exe', '--video', filepath2+'/'+video, '--hand','--face',  '--write_json', filepath4+'/'+videoName])
#'--write_video', filepath5+'/OpenPose'+videoName+'avi',