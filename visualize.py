...
class Vis:
    ...
    """
    def __init__(self,left_video_path,right_video_path,mid_video_path,coords):
    ...
    def display(self):
        ...
        ax1.set_xlim3d([-50, 50])
        ax1.set_xlabel('X')

        ax1.set_ylim3d([-50,50])
        ax1.set_ylabel('Y')

        ax1.set_zlim3d([-50,50])
        ax1.set_zlabel('Z')


        ax2 = plt.subplot(2,3,2) #x,y,z value
        ...
        c = 0
        while c < d.shape[0]:
            temp = ax1.scatter3D(d[c,:25,0], d[c,:25,1], d[c,:25,2], marker='o', cmap='hot',s=20)
            temp2 = ax1.scatter3D(d[c,25:,0], d[c,25:,1], d[c,25:,2], marker='o', cmap='hot',s=100)
