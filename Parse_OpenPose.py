                ...
                if len(allPeople) == 0:# If the amount of people in frame is zero
                    ...
                    for person in range(len(allPeople)):#iterates through each person in frame                                      
                        ...
                        if include_OpenPoseHands: #If you include hands
                            hand_left = f.get('Cameras/'+str(cam_names[camera])+'/Frame'+str(frame)+'/Person'+str(person)+'/Left Hand')# Gets the left hand openpose data
                            hand_left = [()]# access left hand data
                            hand_right = f.get('Cameras/'+str(cam_names[camera])+'/Frame'+str(frame)+'/Person'+str(person)+'/Right Hand')#Gets the right hand data
                            hand_right = [()]# access right hand data
